...
\end{flushright}
    ...
    解析条件としては角速度$209\ \mathrm{rad/s}$，$314\ \mathrm{rad/s}$，$444\ \mathrm{rad/s}$で検討した．Fig.ブレードピッチ角を変化させた場合の推力の変化を示す．
    ...
    Fig.ピッチ角の変化に対するFigure of Meritの変化を示す．
    ...
    \par
    本節では，Table.に示した3パターンのブレード形状について遠心力によるねじり下げモーメントを計算し，
    ...
    一方，ピッチ角を付けた場合だと，Fig.のように$x$軸と$y$軸の間に遠心力が発生し，$y$軸方向成分によって
    ...
    カウンターウェイトの重量も考慮した際のピッチ角と角速度，Figure of MeritをTable. に示す．
    ...
    検討する．したがって，角速度の値はTable.で決定したものを用いる．
    ...
    $x$軸周りの角速度$\omega$と消費パワー$P$については第節で述べる．
