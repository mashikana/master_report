...
\end{flushright}
    ...
    \label{sec:aircraft}
    \par
    第\ref{chap:previous_research}章の内容から,$F_{z\mathrm{hub}}$を評価指標とし,重心移動による低振動化の効果の確認を
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[keepaspectratio, width=0.8\linewidth]{photo/helicopter_model.png}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[keepaspectratio, width=0.5\linewidth]{photo/IMU.png}
