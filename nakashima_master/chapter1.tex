...
\begin{flushright}
	\begin{minipage}{0.8\hsize}
		\quad 本章では,本論文の研究背景と研究目的について説明する.（Ref.\cite{Yoshizaki_master}参照）
...
\end{flushright}
    ...
    \begin{equation}
        \begin{aligned}
            & S_{zm}=S_{z0}+S_{znc} \cos n \Psi_m+S_{zns} \sin n \Psi_m(n=1, \quad 2 \cdots, \quad m=1, \quad \cdots N) \\
            & S_{xm}=S_{x0}+S_{xnc} \cos n \Psi_m+S_{xns} \sin n \Psi_m(n=1, \quad 2 \cdots, \quad m=1, \quad \cdots N) \\
            & S_{rm}=S_{r0}+S_{rnc} \cos n \Psi_m+S_{rns} \sin n \Psi_m(n=1,2 \cdots, \quad m=1, \quad \cdots N) \\
            & N_{Fm}=N_{F0}+N_{Fnc} \cos n \Psi_m+N_{Fns} \sin n \Psi_m(n=1,2 \cdots, \quad m=1, \quad \cdots N) \\
            & N_{Lm}=N_{L0}+N_{Lnc} \cos n \Psi_m+N_{Lns} \sin n \Psi_m(n=1, \quad 2 \cdots, \quad m=1, \quad \cdots N)  \label{SandN}
        \end{aligned}
    \end{equation}
    ...
    \begin{table}[H]
        \centering
        \caption{$S_z$各周波数成分の胴体系伝達後の$F_{z\mathrm{hub}}$\supcite{johnson_2013}}
    ...
    \begin{table}[H]
        \centering
        \caption{$S_x$,$S_r$各周波数成分の胴体系伝達後の$F_{x\mathrm{hub}}$\supcite{johnson_2013}}
    ...
    \begin{table}[H]
        \centering
        \caption{$S_x$,$S_r$各周波数成分の胴体系伝達後の$F_{y\mathrm{hub}}$\supcite{johnson_2013}}
    ...
    \begin{table}[H]
        \centering
        \caption{$N_F$各周波数成分の胴体系伝達後の$M_{x\mathrm{hub}}$\supcite{johnson_2013}}
    ...
    \begin{table}[H]
        \centering
        \caption{$N_F$各周波数成分の胴体系伝達後の$M_{y\mathrm{hub}}$\supcite{johnson_2013}}
    ...
    \begin{table}[H]
        \centering
        \caption{$N_L$各周波数成分の胴体系伝達後の$M_{z\mathrm{hub}}$\supcite{johnson_2013}}
